<div class="navbar bg-base-100 shadow-lg">
  ...
  <div class="flex-1 md:hidden">
    <div class="dropdown">
      ...
      <li><a href="{{ route('home') }}">Farmacia local</a></li>
  ...
  <div class="flex-1 hidden md:flex space-x-4">
    <a href="{{ route('home') }}" class="btn btn-ghost btn-sm">Farmacia local</a>
  ...
  {{-- Si esta autenticado muestra menu de usuario, si no muestra botones de login y registro --}}
  @auth
